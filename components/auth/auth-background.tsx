...
export const AuthBackground = () => {
    return (
        <>
            <div
                    className="hidden bg-muted lg:block h-full w-full"
                ...
                >
                    ...
                    />
                    <div className="absolute top-1/2 left-1/4 transform -translate-x-1/3 -translate-y-1/2 flex flex-col w-full">  
