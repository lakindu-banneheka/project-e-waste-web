...
import { getReportById, updateReportById } from "@/server/reportWork";
...
const ReportDetails = () => {
    ...
    const updateReportStatus = useMutation({
        ...
        onError: () => {
            toast.error("Something went workng while updating the status")
        },
        onSuccess: () => {
            toast.success("Successfully updated the status of the report.");
            router.push('/review-work')
        }
    });
    const {mutate: update_ReportStatus} = updateReportStatus;
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="w-10/12 space-y-6">
                        ...
                        <FormFieldInput<FormSchemaType>
                            ...
                            disabled={true}
                            isLoading={getReportDataById.isPending || getProjectNameById.isPending}
                        />
                        ...
                        <div className="flex flex-row justify-around md:justify-evenly lg:justify-center items-center space-x-5 lg:space-x-20" >
                            <Button 
                                className="px-10" 
                                onClick={() => {
